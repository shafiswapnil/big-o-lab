...
# python3 -c "from algorithms import constant_access, linear_search, sort_data, bubble_sort; data = [5, 3, 8, 1, 9]; print(constant_access(data)); print(linear_search(data, 9)); print(sort_data(data)); print(bubble_sort(data))"